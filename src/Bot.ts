...
export class Bot {
  ...
  chatCommand(command:string):void{
    ...
    this.core.chatManager.sendCommand(
      command
    );
  ...
  interactEntity(
    ...
    this.core.movement.interactEntity(
      id,
      hand
    );
  ...
  setControlState(
    ...
    this.core.movement.setControlState(
      control,
      state
    );
  ...
  getBlock(
    ...
    return this.core.worldManager.getBlock(
      position
    );
  ...
  getChunk(
    ...
    return this.core.worldManager.getChunk(
      chunkX,
      chunkZ
    );
  ...
  getBiome(
    ...
    return this.core.worldManager.getBiome(
      position
    );
  ...
  raycast(
    ...
    return this.core.worldManager.raycast(
      eyePos,
      direction,
      maxDistance
    );
  ...
  equip(
    itemName:string,
    destination:"hand"|"off-hand"="hand"
  ):boolean {


    return this.core.inventoryManager.equip(
      itemName,
      destination
    );
  ...
  toss(
    ...
    return this.core.inventoryManager.toss(
      itemName,
      amount
    );
  ...
  craft(
    ...
    this.core.inventoryManager.craft(
      recipeId,
      craftAll
    );
  ...
  openChest(
    ...
    return this.core.inventoryManager.openChest(
      windowId
    );
  ...
  openFurnace(
    ...
    return this.core.inventoryManager.openFurnace(
      windowId
    );
  ...
  closeWindow(
    ...
    this.core.inventoryManager.closeWindow(
      windowId
    );
  ...
  setHeldHotbarSlot(
    ...
    this.core.inventoryManager.setHeldHotbarSlot(
      index
    );
  ...
  loadPlugin(
    plugin:GooberPlugin|PluginFactory
  ):void {


    this.core.plugins.load(
      this,
      plugin
    );
  ...
  unloadPlugin(
    ...
    return this.core.plugins.unload(
      this,
      name
    );
